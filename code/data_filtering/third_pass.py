...
def main():
    ...
    base_dir = "Second_Filtered_Data"
    out_file = "third_pass_names.txt"
    filtered_out_file = "third_pass_filtered_out.txt"
    open(out_file, "w").close()
    open(filtered_out_file, "w").close()
    ...
    for sub in os.listdir(base_dir):
        ...
        for fname in os.listdir(inf_dir):
            ...
            messages = [{
                ...
                "content": [
                    ...
                    {"type": "text", "text": "Does this image contain a finite element plot showing a finite element variable (from structural, dynamic, thermal, frequency/vibration, magnetic, electrical, fluid simulations)? Reply only 'True' or 'False'. NOTE: It's not necessary that every colored gradient plot is a finite element plot, so be careful."}
                ]
            }]
        ...
        if not found_true:
            ...
            with open(filtered_out_file, "a") as f:
                f.write(sub + "\n")
