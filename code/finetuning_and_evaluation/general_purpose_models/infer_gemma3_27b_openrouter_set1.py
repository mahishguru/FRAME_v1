...
# ---------- CLI Arguments ----------
parser = argparse.ArgumentParser(description='Inference with Gemma-3-27B-IT via OpenRouter')
parser.add_argument('--api_key', type=str, default="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",
                    help='OpenRouter API key')
parser.add_argument('--model', type=str, default="google/gemma-3-27b-it",
                    help='Model name on OpenRouter (default: google/gemma-3-27b-it)')
...
def run_inference(args):
    ...
    print("=" * 80)
    print("Gemma-3-27B-IT Inference via OpenRouter")
    print("=" * 80)
