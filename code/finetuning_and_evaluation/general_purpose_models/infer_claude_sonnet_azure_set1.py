...
Runs on test set 1 and saves results with incremental checkpoints.
"""
import os
import json
import argparse
...
# Optional list of problematic cases to skip
default_excluded_cases = [
    # "10_1016_j_compstruct_2023_116967",
]

parser = argparse.ArgumentParser(description="Inference with Claude 4.5 Sonnet via Azure Foundry")
...
parser.add_argument('--endpoint', type=str, default="https://llmpost9832750527.services.ai.azure.com/anthropic/",
                    help='Azure Foundry Anthropic endpoint base URL (should end with /anthropic/)')
parser.add_argument('--deployment', type=str, default="claude-sonnet-4-5",
                    help='Deployment name within Azure Foundry')
parser.add_argument('--test_prompts_jsonl', type=str, default="test_prompts_set1.jsonl",
                    help='Path to test prompts JSONL file')
parser.add_argument('--test_images_json', type=str, default="test_images_set1.json",
                    help='Path to test images JSON file')
parser.add_argument('--output_json', type=str, default="claude_sonnet_results_set1.json",
...
parser.add_argument('--excluded_cases', type=str, nargs='*', default=default_excluded_cases,
...
def run_inference():
    ...
    print("=" * 80)
    print("Claude 4.5 Sonnet Inference via Azure AI Foundry")
    print("=" * 80)
