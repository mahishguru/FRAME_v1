...
parser = argparse.ArgumentParser(description='PEFT fine-tuning for Qwen3-VL-8B-Instruct (70% data)')
...
if args.model_dir is None:
    args.model_dir = f"{args.model_name.split('/')[-1]}_p70"
...
print("\n" + "="*80)
print("Starting Qwen3-VL-8B-Instruct Fine-Tuning (70% data)")
print("="*80 + "\n")
