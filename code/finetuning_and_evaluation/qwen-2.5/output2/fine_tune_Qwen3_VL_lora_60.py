...
parser = argparse.ArgumentParser(description='PEFT fine-tuning for Qwen3-VL-8B-Instruct (60% data)')
...
parser.add_argument('--model_dir', type=str, default="60_percent_finetuned_qwen3vl_model")
...
if args.model_dir is None:
    args.model_dir = f"{args.model_name.split('/')[-1]}_p60"
...
print("\n" + "="*80)
print("Starting Qwen3-VL-8B-Instruct Fine-Tuning (60% data)")
print("="*80 + "\n")
